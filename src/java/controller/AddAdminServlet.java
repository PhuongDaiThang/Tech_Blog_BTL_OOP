...
public class AddAdminServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        User u2 = uDAO.findUserByEmail(email);
        if(u1 == null && u2 == null){
            User u = new User(1, username, email, password, gender, about);
            uDAO.insertUser(u);
            signupMessage = "Thêm thành công";
        }
        else{
            signupMessage = "Thông tin đã tồn tại!";
        }
